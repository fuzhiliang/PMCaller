...
#	$cmd .="perl $Bin/bin/gy_sam_Error_Table_High_Low_v2.1.pl $out/$sample.snp.gy   $bam  $out/errortable/  $L_list $cut_H";
	$cmd .="perl $Bin/bin/gy_sam_Error_Table_High_Low_hg_cutH.v2.1.pl $out/$sample.snp.gy   $bam  $out/errortable/  $L_list $cut_E";
...
foreach my $L (@L_list) {
	$cmd .="awk '{if (\$1==$cut_E && \$2==$L){print \$3\"\\t\"\$4\"\\t\"\$5\"\\t\"\$6\"\\t\"\$5/\$6}}' $out/errortable/$sample.errortable.list > $out/errortable/$sample.errortable.list_$L \n";
	$cmd .="awk '{if (\$1==$cut_E && \$2==$L){print \$3\"\\t\"\$4\"\\t\"\$5\"\\t\"\$6\"\\t\"\$5/\$6}}' $out/errortable/$sample.HighQual.errortable.list > $out/errortable/$sample.errortable.list_$L.HighQual \n";
	$cmd .="awk '{if (\$1==$cut_E && \$2==$L){print \$3\"\\t\"\$4\"\\t\"\$5\"\\t\"\$6\"\\t\"\$5/\$6}}' $out/errortable/$sample.LowQual.errortable.list > $out/errortable/$sample.errortable.list_$L.LowQual  \n";
	$cmd .="awk '{if (\$1==$cut_E && \$2==$L){print \$3\"\\t\"\$4\"\\t\"\$5\"\\t\"\$6\"\\t\"\$5/\$6}}' $out/errortable/$sample.EXON.errortable.list > $out/errortable/$sample.errortable.list_$L.EXON \n";
	$cmd .="awk '{if (\$1==$cut_E && \$2==$L){print \$3\"\\t\"\$4\"\\t\"\$5\"\\t\"\$6\"\\t\"\$5/\$6}}' $out/errortable/$sample.INT.errortable.list > $out/errortable/$sample.errortable.list_$L.INT  \n";
}
