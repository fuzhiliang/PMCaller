...
die "perl $0 *snp.gy  /56T/Evan/PMCaller/mydata/DNA.C10T_1.sam|bam  /56T/Evan/PMCaller/mydata/all/errrortable_ski/error. 5:7:9:11:13:15  30:40:50:60:70" if (@ARGV <= 4) ;
